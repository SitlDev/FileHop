...
export const mockQualityMeasures = [
  ...
  },
  {
    ...
    facility_score: 22.4,
    state_average: 22.8,
    national_average: 24.1,
    comparison: 'Same',
    reporting_period: 'Q1 2026',
  },
  {
    id: '4',
    measure_name: 'Hospital readmission within 30 days',
    facility_score: 18.7,
    state_average: 16.2,
    national_average: 15.8,
    comparison: 'Worse',
    reporting_period: 'Q1 2026',
  },
  {
    id: '5',
    measure_name: 'Residents with a urinary tract infection',
    facility_score: 7.2,
    state_average: 8.1,
    national_average: 8.5,
    comparison: 'Better',
    reporting_period: 'Q1 2026',
  },
];
